...
//create recipes
recipes.addShaped("Xtones Tiles", <xtones:base> * 8, [[<ore:slabStone>, <ore:stone>, <ore:itemClay>], [<ore:stone>, craftingItem.reuse(), <ore:stone>], [<ore:itemClay>, <ore:stone>, <ore:slabStone>]]);
